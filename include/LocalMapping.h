...
public:
    ...
    void SetImageMatcher(KeyPointImageMatcher *pImageMatcher);
    void SendImgdata();
    void SetKeyFrameGeoPose();
    void FirstGeoInitialized();
    void SecondGeoInitialized();
    g2o::Sim3 mg2oSwg;//地理坐标系到SLAM世界坐标系
    bool mDoneBA;

    //SLAM的地理初始化分为两步，
    bool mbFirstGeoInitialized;
    bool mbSecondGeoInitialized;
...
protected:
    ...
    Tracking *mpTracker;
    KeyPointImageMatcher *mpImageMatcher;

    
    double minit_T_c2geo_data[12];
