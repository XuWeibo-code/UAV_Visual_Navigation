...
public:
    ...
    double init_T_c2geo_tq[7] = {12157200.585966000, 4045679.127711000, 603.924970000, -0.627283000, 0.778791000, -0.000680000, 0.000547000};
    ...
    void SaveTrajectoryGeo(const string &filename);
    void SaveTrajectoryGeoz0(const string &filename);
