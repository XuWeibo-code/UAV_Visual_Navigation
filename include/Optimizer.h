...
public:
    ...
    void static GeoLocalBundleAdjustment(KeyFrame *pKF, bool *pbStopFlag, bool GeoInitialize, g2o::Sim3& g2oSwg, Map *pMap, int &num_fixedKF, int &num_OptKF, int &num_MPs, int &num_edges);
